...
namespace kozakova
{
  void insert(std::map< std::string, ERDictionary >& dicts, std::istream& in, std::ostream& out);
  void search(const std::map< std::string, ERDictionary >& dicts, std::istream& in, std::ostream& out);
  void remove(std::map< std::string, ERDictionary >& dicts, std::istream& in, std::ostream& out);
