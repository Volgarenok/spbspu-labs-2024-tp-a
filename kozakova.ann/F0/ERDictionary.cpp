...
bool kozakova::ERDictionary::removetranslation(const std::string& word, const std::string& trans)
{
...
bool kozakova::shortTrans(const std::string& trans1, const std::string& trans2)
{
...
{
  return *std::min_element(dictionary.at(word).begin(), dictionary.at(word).end(), shortTrans);
}
