...
void lazareva::list_tables(HashTable& tables, std::ostream& out)
{
    if (tables.empty()) {
        out << "No tables available.\n";
        return;
    }
...
void lazareva::check_table_exists(HashTable& tables, std::istream& in, std::ostream& out)
{
    std::string table;
    in >> table;
