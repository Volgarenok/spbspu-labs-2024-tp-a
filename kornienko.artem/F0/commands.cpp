...
void kornienko::merge(std::istream & in, std::ostream & out, mapDict & dictionaries)
{
  ...
  {
    dictionaries[newName].dictionary_.insert(dictionaries[name1].dictionary_.begin(), dictionaries[name1].dictionary_.end());
  }
  else if (itDict2 != dictionaries[name2].dictionary_.end())
  {
    dictionaries[newName].dictionary_.insert(dictionaries[name2].dictionary_.begin(), dictionaries[name2].dictionary_.end());
  }
}
