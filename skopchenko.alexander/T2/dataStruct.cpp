...
std::istream& skopchenko::operator>>(std::istream& in, DataStruct& data)
{
...
std::ostream& skopchenko::operator<<(std::ostream& out, const DataStruct& data)
{
...
bool skopchenko::operator<(const DataStruct& lhs, const DataStruct& rhs)
{
