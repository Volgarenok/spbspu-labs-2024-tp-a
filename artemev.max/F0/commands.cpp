...
void artemev::printHelp()
{
  ...
  std::cout << "считывает текст из файла <file> и записывает под именем <textName>\n";
  std::cout << "2. code <textName> <codeName> - ";
  std::cout << "создает кодировку из незашифрованного текста <textName> и сохраняет под именем <codeName>,";
  std::cout << "выводя в стандартный поток вывода информацию о кодировке в виде: \n";
  std::cout << "[{символ}] = {количество встречаемого в тексте символа}: {бинарный код символа}\n";
  std::cout << "3. encode <textName>  <codeName> <codedText> - ";
  std::cout << "кодирует текст <textname>, используя кодировку <codename> и записывает результат в новый текст <codedtext>\n";
  std::cout << "4. write <codeName> <codedText> <newFileName> - ";
  std::cout << "создает закодированный файл <newFileName> на основании кодировки <codeName> и закодированного текста <codedText>\n";
  std::cout << "5. uncode <textName> <fileName> - расшифровывает текст <textName> и записывает в файл <fileName>\n";
  std::cout << "6. save text <textName> <newFile> - сохраняет текст <textName> в новый файл\n";
