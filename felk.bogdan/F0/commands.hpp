...
namespace felk
{
  ...
  void setNewNumber(std::istream& in,  std::unordered_map< std::string, Dict >&);
  void getMean(std::istream& in, std::ostream& out, std::unordered_map< std::string, Dict >&);
  void clear(std::istream& in, std::unordered_map< std::string, Dict >&);
  ...
  void deleteKey(std::istream& in, std::unordered_map< std::string, Dict >&);
