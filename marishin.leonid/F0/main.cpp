...
public:
    ...
    Note(const std::string& k, const std::string& d) : key(k), description(d) {}
...
int main(int argc, char* argv[]) {
    ...
    cmds["add"] = std::bind(executeAddNote, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["remove"] = std::bind(executeRemoveNote, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["create"] = std::bind(executeCreateNotebook, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-create"] = std::bind(executeCreateTag, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-delete"] = std::bind(executeDeleteTag, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-add"] = std::bind(executeAddTagToNote, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-remove"] = std::bind(executeRemoveTagFromNote, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-create-book"] = std::bind(executeCreateNotebookFromTags, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-merge-books"] = std::bind(executeMergeNotebooksByTags, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
    cmds["tag-sort-entries"] = std::bind(executeSortEntriesByTag, std::ref(manager), std::placeholders::_1, std::placeholders::_2);
